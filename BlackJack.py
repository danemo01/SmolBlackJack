...
class BlackJackMenu(Frame):
	...
	def __init__(self):
		...
		self.buttonGame = Button (self, text = "Play BlackJack!", width = 25, command = self.playGame)
		self.buttonDisplayFunds = Button (self, text = "Display Available Funds", width = 25, command = self.showFunds)
		self.buttonResetFunds = Button (self, text = "Reset Funds", width = 25, command = self.resetFunds)
		self.buttonQuit = Button (self, text = "Quit", width = 25, command = self.close_window)
